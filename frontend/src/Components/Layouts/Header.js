...
function Header() {
  ...
  return (
    <div className="headercustom">
      <div className="navbar">
        {isLogin && <img className="logo" src="/OptiCool Logo.png" alt="OptiCool Logo" />}
        <div className="logo-container">
          {isLogin && (
            <>
              <span className="logo-title">Home</span>
            ...
            <Drawer anchor="right" open={drawerOpen} onClose={toggleDrawer(false)}>
              <List sx={{ width: 250 }}>
                <ListItem disablePadding>
                  <ListItemButton onClick={() => { navigate("/home"); setDrawerOpen(false); }}>
                ...
                <ListItem disablePadding>
                  <ListItemButton onClick={() => { navigate("/manageRoom"); setDrawerOpen(false); }}>
                ...
                <ListItem disablePadding>
                  <ListItemButton onClick={() => { navigate("/me"); setDrawerOpen(false); }}>
